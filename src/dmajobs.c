...
dma_job dma_clearheaderlinecolorram2 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
...
dma_job dma_clearheaderlinescreenram1 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
	...
	.command				= 0b00000011, // fill, no chain
	.count					= 2*RRBSCREENWIDTH,
	.source_addr			= (((FONTCHARMEM/64 + 0) >> 0)) & 0xff,
	.source_bank_and_flags	= 0x00,
...
dma_job dma_clearheaderlinescreenram2 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
	...
	.command				= 0b00000011, // fill, no chain
	.count					= 2*RRBSCREENWIDTH,
	.source_addr			= (((uint32_t)(FONTCHARMEM/64 + 0) >> 8)) & 0xff,
	.source_bank_and_flags	= 0x00,
...
dma_job dma_clearfooterlinescolorram1 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((SAFE_COLOR_RAM + 38*RRBSCREENWIDTH2) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	.end_options			= 0x00,
	.command				= 0b00000011, // fill, no chain
	.count					= 4*RRBSCREENWIDTH,
	.source_addr			= 0b0000000000001100, // 00001000 = NCM chars, 00000100 = trim 8 pixels
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((SAFE_COLOR_RAM + 38*RRBSCREENWIDTH2) & 0xffff),
	.dest_bank_and_flags	= (((SAFE_COLOR_RAM + 38*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.modulo					= 0x0000
};

dma_job dma_clearfooterlinescolorram2 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((SAFE_COLOR_RAM + 38*RRBSCREENWIDTH2 + 1) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_addr			= 0b0000000000001111, // 00000000 = $0f = pixels with value $0f take on the colour value of $0f as well
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((SAFE_COLOR_RAM + 38*RRBSCREENWIDTH2 + 1) & 0xffff),
	.dest_bank_and_flags	= (((SAFE_COLOR_RAM + 38*RRBSCREENWIDTH2 + 1) >> 16) & 0x0f),
	.modulo					= 0x0000
};

dma_job dma_clearfooterlinesscreenram1 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SCREEN + 38*RRBSCREENWIDTH2) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_addr			= (((FONTCHARMEM/64 + 0) >> 0)) & 0xff,
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((uint32_t)(SCREEN + 38*RRBSCREENWIDTH2) & 0xffff),
	.dest_bank_and_flags	= (((uint32_t)(SCREEN + 38*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.modulo					= 0x0000
};

dma_job dma_clearfooterlinesscreenram2 =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SCREEN + 38*RRBSCREENWIDTH2 + 1) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_addr			= (((uint32_t)(FONTCHARMEM/64 + 0) >> 8)) & 0xff,
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((uint32_t)(SCREEN + 38*RRBSCREENWIDTH2 + 1) & 0xffff),
	.dest_bank_and_flags	= (((uint32_t)(SCREEN + 38*RRBSCREENWIDTH2 + 1) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_cleartoplinecolorram1 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_addr			= 0b0000000000001100, // 00001000 = NCM chars, 00000100 = trim 8 pixels
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2) & 0xffff),
	.dest_bank_and_flags	= (((SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_cleartoplinecolorram2 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 1) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_addr			= 0b0000000000001111, // 00000000 = $0f = pixels with value $0f take on the colour value of $0f as well
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 1) & 0xffff),
	.dest_bank_and_flags	= (((SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 1) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_cleartoplinescreenram1 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_bank_and_flags	= 0x00,
	.dest_addr				=  ((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2) & 0xffff),
	.dest_bank_and_flags	= (((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_cleartoplinescreenram2 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2 + 1) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.dest_bank_and_flags	= (((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2 + 1) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_copycolorramup =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= ((uint32_t)(SAFE_COLOR_RAM + 4*RRBSCREENWIDTH2) >> 20),
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x01,
	...
	.source_addr			= ((uint32_t)(SAFE_COLOR_RAM + 4*RRBSCREENWIDTH2) & 0xffff),
	.source_bank_and_flags	= (((uint32_t)(SAFE_COLOR_RAM + 4*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.dest_addr				= ((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2) & 0xffff),
	.dest_bank_and_flags	= (((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_copyscreenramup =
{
	.type					= 0x0a,
	.sourcemb_token			= 0x80,
	.sourcemb				= ((uint32_t)(SCREEN + 4*RRBSCREENWIDTH2) >> 20),
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	...
	.command				= 0b00000000, // copy, no chain
	.count					= 36*RRBSCREENWIDTH2,
	.source_addr			= ((uint32_t)(SCREEN + 4*RRBSCREENWIDTH2) & 0xffff),
	.source_bank_and_flags	= (((uint32_t)(SCREEN + 4*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.dest_addr				= ((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2) & 0xffff),
	.dest_bank_and_flags	= (((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_clearfullcolorram1 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((SAFE_COLOR_RAM + 0*RRBSCREENWIDTH2 + 0) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.source_addr			= 0b0000000000001100, // 00001000 = NCM chars, 00000100 = trim 8 pixels
	.source_bank_and_flags	= 0x00,
	.dest_addr				= ((SAFE_COLOR_RAM + 0*RRBSCREENWIDTH2 + 0) & 0xffff),
	.dest_bank_and_flags	= (((SAFE_COLOR_RAM + 0*RRBSCREENWIDTH2 + 0) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_clearcolorram1 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 0) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.dest_bank_and_flags	= (((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 0) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_clearcolorram2 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 1) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.dest_bank_and_flags	= (((uint32_t)(SAFE_COLOR_RAM + 2*RRBSCREENWIDTH2 + 1) >> 16) & 0x0f),
	.modulo					= 0x0000
};
...
dma_job dma_clearscreen1 =
{
	...
	.sourcemb				= 0x00,
	.destmb_token			= 0x81,
	.destmb					= ((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2 + 0) >> 20),
	.dskipratefrac_token	= 0x84,
	.dskipratefrac			= 0x00,
	.dskiprate_token		= 0x85,
	.dskiprate				= 0x02,
	...
	.dest_bank_and_flags	= (((uint32_t)(SCREEN + 2*RRBSCREENWIDTH2 + 0) >> 16) & 0x0f),
	.modulo					= 0x0000
};
